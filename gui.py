...
class App:
    def __init__(self, root):
        ...
        self.entry_password = tk.Entry(self.form_frame)
        self.entry_password.grid(row=2, column=1, sticky="ew")
    ...
    def submit_data(self):
        ...
        fullname = self.entry_password.get()
        email = self.entry_password.get()
        current_address = self.entry_password.get()
        permanet_address = self.entry_password.get()
        
        self.web_automation = WebAutomation()
        self.web_automation.login(username, password)
        self.web_automation.fill_form(fullname, email, current_address, permanet_address)
